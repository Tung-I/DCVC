...
class DirectVoxGO(torch.nn.Module):
    def __init__(self, xyz_min, xyz_max,
        ...
        # so that after the softplus in Raw2Alpha, initial occupancy probability ~= alpha_init
    ...
    def scale_volume_grid(self, num_voxels):
        ...
        if np.prod(self.world_size.tolist()) <= 256**3:
            ...
            # Applies a 3×3×3 max‐pool to cover “thin” free‐space gaps.
    ...
    def forward(self, rays_o, rays_d, viewdirs, shared_rgbnet=None, global_step=None, mode='feat', **render_kwargs):
        ...
        # skip known free space: any voxel with a cached α below fast_color_thres 
