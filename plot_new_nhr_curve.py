...
# ============================================================
# 1) USER-EDITABLE DATA (NHR RD points)
# ============================================================
...
#    (Same as your previous script so style is consistent)
# ============================================================
...
#    Reuse same layout / limits as your previous script
# ============================================================
...
FIGURE_SPECS: List[Dict[str, Any]] = [
    {
        ...
        "yticks": [26.0, 27.0, 28.0, 29.0, 30.0, 31.0, 32.0, 33.0],
        "show_xlabel": True,
        "show_ylabel": True,
        "show_legend": True,
...
DEFAULT_ROOT_DIR = "plots_new_nhr"
TITLE_FONT_SIZE = 18
LEGEND_FONT_SIZE = 12
