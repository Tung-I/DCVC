...
fine_train = dict(
    ...
    tv_before=15000,                  # count total variation before the given number of iterations
    tv_dense_before=15000,            # count total variation densely before the given number of iterations
