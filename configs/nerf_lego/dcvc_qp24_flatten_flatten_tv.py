_base_ = '../default.py'
expname = 'dcvc_qp24_flatten_flatten_tv'
ckptname = 'lego_image'
...
fine_train = dict(
    ...
    tv_after=12000,                   # count total variation loss from tv_from step
    ...
    weight_tv_density=2e-6,        # weight of total variation loss of density voxel grid
	weight_tv_k0=2e-6,
	weight_l1_loss=None,
