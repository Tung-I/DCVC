...
codec = dict(
    ...
    quant_mode="global",   # "global" will be interpreted as "absmax"
    ...
    # choose ONE hardware codec QP
    hevc_qp=None,
    av1_qp=44,
    vp9_qp=None,   # ignored by PyNvVideoCodecWrapper

    # hardware-specific knobs
    gpu_id=0,
    hw_preset='p4',
    hw_tune='high_quality',

    # optional explicit range knobs used by the wrapper
    absmax_lo=-20.0,
    absmax_hi=20.0,
    affine_lo_p=0.5,
    affine_hi_p=99.5,
